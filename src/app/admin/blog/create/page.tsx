  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (featuredImage) {
        ...
        console.log('Uploading featured image:', featuredImage.file.name, featuredImage.file.size, featuredImage.file.type)
      ...
      let contentImageAsset = null
      if (contentImage) {
        const formData = new FormData()
        formData.append('file', contentImage.file)
        formData.append('alt', contentImageAlt)
        
        console.log('Uploading content image:', contentImage.file.name, contentImage.file.size, contentImage.file.type)
        ...
        console.log('Content image upload response status:', uploadResponse.status)
        console.log('Content image upload response ok:', uploadResponse.ok)
        ...
        const uploadResult = await uploadResponse.json()
        console.log('Content image upload result:', uploadResult)
          ...
          <div className="py-6 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Create a new blog post with a featured image and optional content image
              </p>
            </div>
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
            <div className="bg-white shadow rounded-lg">
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting || !excerpt.trim()}
